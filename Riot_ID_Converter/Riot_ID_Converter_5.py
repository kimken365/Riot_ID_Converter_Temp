...
riot_id_table = {
    ...
    'baby princess': ['baby princess#hime', '姐姐的貓#pet'],
    ...
    'Danman fan 96': ['Marius#Aya', 'きえたい#1798'],
    'Dûnk': ['Dunk#NA2'],
    'EVERYBODYKILLER': ['prodigy zzz#NA1', 'EVERYBODYKILLER#NA1'],
    'Exile Syre': ['Syre#Exile'],
    'goat of rakan': ['emanex#0519'],
    'hallucinate': ['hallucinate#xo'],
    'Her Boba': ['Her Boba#ily'],
    'Hoppermh': ['Hoppermh#NA1', 'Galaxy Kitty#NA1'],
    ...
    'ryginltga': ['ryginltga#NA1', 'Hashtag#NA2'],
    'Rezzy': ['Rezzy#101'],
    'Richard Socks ON': ['C Tier Fill#Socks'],
    'rohan': ['rohan#9999'],
    'Samba': ['Samba#555'],
    'Sated': ['Sated#YASUO'],
    'Shin Reisurodo': ['福生玄黄天尊#0001', 'Tama#0777'],
    'Slainy': ['Slain#NA2'],
    'Slimere': ['Slimere#BBC'],
    ...
    'Yunì': ['Yunì#9864'],
    'Zavøky': ['Zav#777', 'zzzgzGGGgjgRr532#NA1'],
    'Z 4': ['Z 4#CLAP'],
    '545': ['big c#rng']
}
